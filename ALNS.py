...
from CR import CustomerRemoval
from CI import CustomerInsertion
from SR import StationRemoval
...
class ALNS:
    ...
    def run(
        ...
        for i in range(1, N+1):
            ...
            distance_iteration.append(helper.total_distance_list(prev_solution))
        ...
        return best_solution, initial_solution, distance_iteration, N
